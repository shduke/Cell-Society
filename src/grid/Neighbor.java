...
public enum Neighbor {
    SQUARE("TOPLEFT", "MIDLEFT", "BOTTOMLEFT", "TOPMID", "BOTTOMMID", "TOPRIGHT", "MIDRIGHT", "BOTTOMRIGHT"),
    ...
    private enum Positions {
        TOPLEFT(-1, -1), MIDLEFT(-1, 0), BOTTOMLEFT(-1, 1), TOPMID(0, -1), BOTTOMMID(0, 1), TOPRIGHT(1, -1), MIDRIGHT(1, 0), BOTTOMRIGHT(1, 1);
